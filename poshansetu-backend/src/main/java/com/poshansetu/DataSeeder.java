...
public class DataSeeder implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        User parent1 = userRepository.save(User.builder()
        ...
        User parent2 = userRepository.save(User.builder()
        ...
        log.info("Created users: Worker={}, Parent1={}, Parent2={}, Admin={}", worker.getPhone(), parent1.getPhone(), parent2.getPhone(), admin.getPhone());
            ...
            for (int v = 0; v < vaccineNames.length; v++) {
                ...
                if (v < 5) {
                    ...
                    status = (child.getFullName().contains("Aarav") || child.getFullName().contains("Ravi"))
                             ? VaccineStatus.MISSED : VaccineStatus.PENDING;
        ...
        for (Child child : children) {
            for (int day = 90; day >= 0; day--) {
                ...
                boolean mealEaten = status == AttendanceStatus.PRESENT && rng.nextDouble() > 0.2; // 80% meals when present
